# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 12:44:43 2020
...
for epoch in tqdm(range(1, epochs+1)):
    ...
    torch.save(model.state_dict(), f'eng_STA_finetuned_BERT_epoch_{epoch}.model')
...
plt.legend()
plt.title("Training loss for English Sub-Task A")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig("Loss_eng_STA.jpg")
plt.clf()
...
plt.legend()
plt.title("Validation loss for English Sub-Task A")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig("ValLoss_eng_STA.jpg")
plt.clf()
...
plt.legend()
plt.title("F1 score for English Sub-Task A")
plt.xlabel("Epochs")
plt.ylabel("F1")
plt.savefig("F1_eng_STA.jpg")
...
model.load_state_dict(torch.load('eng_STA_finetuned_BERT_epoch_5.model', map_location=torch.device('cpu')))
